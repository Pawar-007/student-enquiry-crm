...
public class EnrollmentServiceImpl implements EnrollmentService {
    ...
    @Override
    @Transactional   // sab kuch ek transaction mein - beech mein fail hua to sab rollback
    public EnrollmentResponseDTO confirmAdmission(EnrollmentRequestDTO dto) {
        ...
        // Student find karo (agar already exist karta hai mobile se) ya naya banao
        ...
        // Enquiry status update - admission ho gaya
